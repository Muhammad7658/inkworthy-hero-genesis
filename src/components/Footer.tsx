      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            <div className="mb-6">
              <h3 className="text-2xl font-playfair font-bold text-indigo-900 mb-2">
                InkWorthy Creations
              </h3>
          ...
          {/* NAVIGATION COLUMN */}
          <div>
            <h4 className="text-lg font-playfair font-semibold text-indigo-900 mb-4">
              Navigation
            </h4>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <a
                  href="#"
                  className="w-10 h-10 rounded-full bg-indigo-900/5 hover:bg-indigo-900/10 flex items-center justify-center text-indigo-900 hover:text-gold-600 transition-colors duration-200"
                  aria-label="LinkedIn"
                >
        ...
        {/* SEPARATOR */}
        <Separator className="bg-indigo-900/10 mb-8" />
